...
//這次又學到了新的編譯器git，我覺得讓整個程式設計不會那麼枯燥乏味，之前助教上課時也有說過，出了社會不會用git的話也不會有競爭力
//所以我認為能早接觸git就早點學習，很謝謝助教還花時間教我們如何使用git，除此之外，只要我們有問題，助教和老師們都會很有耐心的幫我們解惑  
//自從學了git之後我發現，每個語言都有他們讀的寫法，害得我對git有點卻步，但轉念一想，我畢竟才學了幾個禮拜，能做成這樣應該算還可以了 吧...? 
//最後還是希望在大一結束後我能活用git，把它融合進dev c++ 
